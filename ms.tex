...
We first calculate the LOSV to each galaxy, where
\begin{equation}
...
For a richness-mass relation with an intrinsic scatter of $\langle \sigma_{M|\lambda} \rangle = 0.25$, and following the more traditional parameterization of the richness-mass relation \citeeg{Rykoff2012, Farahi2016}, we find a best-fitting relation for the targeted observations as
\begin{equation}
